...
class BookedMealsClient {
  ...
  @Published var reservationMeals = [ReservationMeal]()
...
//            ingredients: document.get("ingredients") as! [String],
  ...
  func fetchMealforReservation(reservation: Reservation, completion: @escaping (ReservationMeal) -> ()){
      //var meal : Meal
...
//      let res = reservation
  ...
  //func fetchRMsforReservations1(reservations: [Reservation], )
  
  func fetchData(user_id: String, completion: @escaping ([ReservationMeal]) -> ()) {
    //let dispatchGroup = DispatchGroup()
    var reservationMeals = [ReservationMeal]()
    self.fetchReservationsForGuestId(user_id: user_id) {
      ...
      for reservation in reservations{
        ...
        self.fetchMealforReservation(reservation: reservation) {
          (rm) in
          //print("FLAKJSDFLKAJDSFKLAJDSKLF")
          //print(rm)
